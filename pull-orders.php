...
<body class="bg-[#edf2f9] font-Poppins m-0 p-0">
                ...
                <li id="store" class="">
                    ...
                    <div class="pt-2 pl-4">
                        <ul class="flex flex-col pl-2 text-[#666666] border-l border-[#353535]">
                            ...
                            <li><a href="pull-orders.php" class="inline-block w-full px-4 py-2 text-xs rounded hover:bg-blue-400 hover:text-white active">Pull Orders</a></li>
    ...
    <main class="md:ml-[190px] lg:ml-[255px]">
        ...
        <div class="m-0 p-4 w-full bg-gray-100 shadow-md">
            <h2 class="font-semibold uppercase text-[14px]">Pull Orders</h2>
        </div>
        <div class="p-6">
